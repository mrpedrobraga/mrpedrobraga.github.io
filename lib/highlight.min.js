...
;hljs.registerLanguage("go",e)})();/*! `lua` grammar compiled for Highlight.js 11.9.0 */
...
;hljs.registerLanguage("typescript",e)})();/*! `x86asm` grammar compiled for Highlight.js 11.9.0 */
